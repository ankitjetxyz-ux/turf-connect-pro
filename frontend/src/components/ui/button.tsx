  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-heading",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-primary-foreground font-bold shadow-glow hover:shadow-elevated hover:scale-105 active:scale-[0.98]",
        glass: "glass-effect text-foreground hover:bg-card/90 border-primary/20 hover:border-primary/50 active:scale-[0.98]",
        glow: "bg-primary/20 text-primary border border-primary/50 hover:bg-primary hover:text-primary-foreground animate-pulse-glow active:scale-[0.98]",
      },
      size: {
